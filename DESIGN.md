...
| M3a | **The sprint** (one scramble for the lobby, first pop wins, the winner's station lit; a win needs a race) and your best time painted on your own mat. Design: `DESIGN-M3.md`, approved 2026-09-24. | building |
| M3b | Global weekly leaderboard (OrderedDataStore -- keyed per depth or not at all), daily streak + daily quests paying boxes, **rebirth** (reset coins and depth for a permanent multiplier), arrow fade at high depth | design |
